...
const images: GalleryImage[] = [
  {
    src: 'https://res.cloudinary.com/dphq9ymvo/image/upload/v1776171810/b5d14e85-4111-4888-9c47-35c6421bfde2_fnds7h.jpg',
    alt: 'Momento en Cafetería Ébenezer',
    label: 'Ébenezer',
    caption: 'Cada taza, una composición efímera',
    index: '01',
  },
  {
    src: 'https://res.cloudinary.com/dphq9ymvo/image/upload/v1776171809/WhatsApp_Image_2026-03-06_at_13.08.19_dhckbw.jpg',
    alt: 'Cafetería Ébenezer — ambiente y producto',
    label: 'Artesanía',
    caption: 'Veinticinco segundos, la medida exacta',
    index: '02',
  },
  {
    src: 'https://res.cloudinary.com/dphq9ymvo/image/upload/v1776171808/WhatsApp_Image_2026-03-17_at_17.49.35_m03eox.jpg',
    alt: 'Plato de Cafetería Ébenezer',
    label: 'Producto',
    caption: 'Pan tostado, ingredientes generosos',
    index: '03',
  },
  {
    src: 'https://res.cloudinary.com/dphq9ymvo/image/upload/v1776171808/b1f54dc0acf5621a85c8dc61395c19a4_qwf9qe.jpg',
    alt: 'Pizza artesanal de Ébenezer',
    label: 'Masa madre',
    caption: 'Cuarenta y ocho horas de espera',
    index: '04',
  },
  {
    src: 'https://res.cloudinary.com/dphq9ymvo/image/upload/v1776171782/WhatsApp_Image_2026-03-17_at_17.49.00_ggajjh.jpg',
    alt: 'Repostería artesanal de Ébenezer',
    label: 'Repostería',
    caption: 'Frutas rojas y almendra tostada',
    index: '05',
  },
  {
    src: 'https://res.cloudinary.com/dphq9ymvo/image/upload/v1776171782/WhatsApp_Image_2026-03-17_at_17.48.56_jlasjx.jpg',
    alt: 'Especialidad de Cafetería Ébenezer',
    label: 'Oficio',
    caption: 'Receta clásica, ejecución impecable',
    index: '06',
  },
  {
    src: 'https://res.cloudinary.com/dphq9ymvo/image/upload/v1776171781/WhatsApp_Image_2026-03-17_at_17.48.53_vs8w5h.jpg',
  ...
  {
    src: 'https://res.cloudinary.com/dphq9ymvo/image/upload/v1776171742/WhatsApp_Image_2026-03-17_at_17.48.41_bbppun.jpg',
    alt: 'La barra de Cafetería Ébenezer',
    label: 'La barra',
